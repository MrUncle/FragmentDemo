...
public class MyTabActivity extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        LayoutInflater.from(this).inflate(R.layout.activity_mytab,
        ...
        tabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener(){
            ...
            public void onTabChanged(String tabId) {
                if (tabId.equals("tab1")) {   //第一个标签
                    Toast.makeText(MyTabActivity.this, "点击标签页一", Toast.LENGTH_SHORT).show();
                }
                if (tabId.equals("tab2")) {   //第二个标签
                    Toast.makeText(MyTabActivity.this, "点击标签页二", Toast.LENGTH_SHORT).show();
                }
                if (tabId.equals("tab3")) {   //第三个标签
                    Toast.makeText(MyTabActivity.this, "点击标签页三", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
