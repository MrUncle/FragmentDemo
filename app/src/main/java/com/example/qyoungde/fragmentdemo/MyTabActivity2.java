...
public class MyTabActivity2 extends Activity
{
    @Override
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        // 方法2、3使用：
        setContentView(R.layout.activity_mytab2);
        ...
        tabHost.setOnTabChangedListener(new OnTabChangeListener(){
            ...
            public void onTabChanged(String tabId) {
                if (tabId.equals("tab1")) {   //第一个标签
                    Toast.makeText(MyTabActivity2.this, "点击标签页一", Toast.LENGTH_SHORT).show();
                }
                if (tabId.equals("tab2")) {   //第二个标签
                    Toast.makeText(MyTabActivity2.this, "点击标签页二", Toast.LENGTH_SHORT).show();
                }
                if (tabId.equals("tab3")) {   //第三个标签
                    Toast.makeText(MyTabActivity2.this, "点击标签页三", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
